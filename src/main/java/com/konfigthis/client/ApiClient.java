...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("clientId", new ApiKeyAuth("header", "clientId"));
        authentications.put("privateKey", new ApiKeyAuth("header", "privateKey"));
        ...
        if (configuration != null) {
            if (configuration.clientId != null) {
                this.setClientId(configuration.clientId);
            }
            if (configuration.privateKey != null) {
                this.setPrivateKey(configuration.privateKey);
            }
    ...
    public String getPrivateKey() {
        return ((ApiKeyAuth) this.getAuthentication("privateKey")).getApiKey();
    }

    public void setPrivateKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("privateKey")).setApiKey(apiKey);
    }

    public void setPrivateKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("privateKey")).setApiKeyPrefix(prefix);
    }
