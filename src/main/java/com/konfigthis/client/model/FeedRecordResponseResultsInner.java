...
public class FeedRecordResponseResultsInner {
  ...
  public FeedRecordResponseResultsInner() {
  }

  public FeedRecordResponseResultsInner feedId(String feedId) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner feedSource(String feedSource) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner feedType(String feedType) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner partnerId(String partnerId) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner itemsReceived(Long itemsReceived) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner itemsSucceeded(Long itemsSucceeded) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner itemsFailed(Long itemsFailed) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner itemsProcessing(Long itemsProcessing) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner feedStatus(String feedStatus) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner feedDate(OffsetDateTime feedDate) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner batchId(String batchId) {
  ...
  **/
  ...
  public FeedRecordResponseResultsInner modifiedDtm(OffsetDateTime modifiedDtm) {
  ...
  **/
   ...
   * @return the FeedRecordResponseResultsInner instance itself
   */
  public FeedRecordResponseResultsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FeedRecordResponseResultsInner feedRecordResponseResultsInner = (FeedRecordResponseResultsInner) o;
    return Objects.equals(this.feedId, feedRecordResponseResultsInner.feedId) &&
        Objects.equals(this.feedSource, feedRecordResponseResultsInner.feedSource) &&
        Objects.equals(this.feedType, feedRecordResponseResultsInner.feedType) &&
        Objects.equals(this.partnerId, feedRecordResponseResultsInner.partnerId) &&
        Objects.equals(this.itemsReceived, feedRecordResponseResultsInner.itemsReceived) &&
        Objects.equals(this.itemsSucceeded, feedRecordResponseResultsInner.itemsSucceeded) &&
        Objects.equals(this.itemsFailed, feedRecordResponseResultsInner.itemsFailed) &&
        Objects.equals(this.itemsProcessing, feedRecordResponseResultsInner.itemsProcessing) &&
        Objects.equals(this.feedStatus, feedRecordResponseResultsInner.feedStatus) &&
        Objects.equals(this.feedDate, feedRecordResponseResultsInner.feedDate) &&
        Objects.equals(this.batchId, feedRecordResponseResultsInner.batchId) &&
        Objects.equals(this.modifiedDtm, feedRecordResponseResultsInner.modifiedDtm)&&
        Objects.equals(this.additionalProperties, feedRecordResponseResultsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeedRecordResponseResultsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FeedRecordResponseResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeedRecordResponseResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeedRecordResponseResultsInner is not found in the empty JSON string", FeedRecordResponseResultsInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeedRecordResponseResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeedRecordResponseResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeedRecordResponseResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeedRecordResponseResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FeedRecordResponseResultsInner>() {
           @Override
           public void write(JsonWriter out, FeedRecordResponseResultsInner value) throws IOException {
           ...
           @Override
           public FeedRecordResponseResultsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FeedRecordResponseResultsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FeedRecordResponseResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeedRecordResponseResultsInner
  * @throws IOException if the JSON string is invalid with respect to FeedRecordResponseResultsInner
  */
  public static FeedRecordResponseResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeedRecordResponseResultsInner.class);
  }

 /**
  * Convert an instance of FeedRecordResponseResultsInner to an JSON string
  *
  * @return JSON string
  */
