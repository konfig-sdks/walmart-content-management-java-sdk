...
public class PartnerItemIngestionStatus {
 ...
 public enum IngestionStatusEnum {
  ...
  public PartnerItemIngestionStatus martId(Integer martId) {
  ...
  **/
  ...
  public PartnerItemIngestionStatus sku(String sku) {
  ...
  **/
  ...
  public PartnerItemIngestionStatus wpid(String wpid) {
  ...
  **/
  ...
  public PartnerItemIngestionStatus index(Integer index) {
  ...
  **/
  ...
  public PartnerItemIngestionStatus ingestionStatus(IngestionStatusEnum ingestionStatus) {
  ...
  **/
  ...
  public PartnerItemIngestionStatus ingestionErrors(ItemDetailsItemIngestionStatusInnerIngestionErrors ingestionErrors) {
  ...
  **/
   ...
   * @return the PartnerItemIngestionStatus instance itself
   */
  public PartnerItemIngestionStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PartnerItemIngestionStatus partnerItemIngestionStatus = (PartnerItemIngestionStatus) o;
    return Objects.equals(this.martId, partnerItemIngestionStatus.martId) &&
        Objects.equals(this.sku, partnerItemIngestionStatus.sku) &&
        Objects.equals(this.wpid, partnerItemIngestionStatus.wpid) &&
        Objects.equals(this.index, partnerItemIngestionStatus.index) &&
        Objects.equals(this.ingestionStatus, partnerItemIngestionStatus.ingestionStatus) &&
        Objects.equals(this.ingestionErrors, partnerItemIngestionStatus.ingestionErrors)&&
        Objects.equals(this.additionalProperties, partnerItemIngestionStatus.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PartnerItemIngestionStatus {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PartnerItemIngestionStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PartnerItemIngestionStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartnerItemIngestionStatus is not found in the empty JSON string", PartnerItemIngestionStatus.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PartnerItemIngestionStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartnerItemIngestionStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartnerItemIngestionStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartnerItemIngestionStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartnerItemIngestionStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<PartnerItemIngestionStatus>() {
           @Override
           public void write(JsonWriter out, PartnerItemIngestionStatus value) throws IOException {
           ...
           @Override
           public PartnerItemIngestionStatus read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PartnerItemIngestionStatus instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PartnerItemIngestionStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartnerItemIngestionStatus
  * @throws IOException if the JSON string is invalid with respect to PartnerItemIngestionStatus
  */
  public static PartnerItemIngestionStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartnerItemIngestionStatus.class);
  }

 /**
  * Convert an instance of PartnerItemIngestionStatus to an JSON string
  *
  * @return JSON string
  */
