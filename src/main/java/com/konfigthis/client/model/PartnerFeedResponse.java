...
public class PartnerFeedResponse {
 ...
 public enum FeedStatusEnum {
  ...
  public PartnerFeedResponse errors(List<FeedRecordResponseErrorsInner> errors) {
  ...
  public PartnerFeedResponse addErrorsItem(FeedRecordResponseErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public PartnerFeedResponse feedId(String feedId) {
  ...
  **/
  ...
  public PartnerFeedResponse feedStatus(FeedStatusEnum feedStatus) {
  ...
  **/
  ...
  public PartnerFeedResponse ingestionErrors(ItemDetailsItemIngestionStatusInnerIngestionErrors ingestionErrors) {
  ...
  **/
  ...
  public PartnerFeedResponse itemsReceived(Integer itemsReceived) {
  ...
  **/
  ...
  public PartnerFeedResponse itemsSucceeded(Integer itemsSucceeded) {
  ...
  **/
  ...
  public PartnerFeedResponse itemsFailed(Integer itemsFailed) {
  ...
  **/
  ...
  public PartnerFeedResponse itemsProcessing(Integer itemsProcessing) {
  ...
  **/
  ...
  public PartnerFeedResponse offset(Integer offset) {
  ...
  **/
  ...
  public PartnerFeedResponse limit(Integer limit) {
  ...
  **/
  ...
  public PartnerFeedResponse itemDetails(PartnerFeedResponseItemDetails itemDetails) {
  ...
  **/
   ...
   * @return the PartnerFeedResponse instance itself
   */
  public PartnerFeedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PartnerFeedResponse partnerFeedResponse = (PartnerFeedResponse) o;
    return Objects.equals(this.errors, partnerFeedResponse.errors) &&
        Objects.equals(this.feedId, partnerFeedResponse.feedId) &&
        Objects.equals(this.feedStatus, partnerFeedResponse.feedStatus) &&
        Objects.equals(this.ingestionErrors, partnerFeedResponse.ingestionErrors) &&
        Objects.equals(this.itemsReceived, partnerFeedResponse.itemsReceived) &&
        Objects.equals(this.itemsSucceeded, partnerFeedResponse.itemsSucceeded) &&
        Objects.equals(this.itemsFailed, partnerFeedResponse.itemsFailed) &&
        Objects.equals(this.itemsProcessing, partnerFeedResponse.itemsProcessing) &&
        Objects.equals(this.offset, partnerFeedResponse.offset) &&
        Objects.equals(this.limit, partnerFeedResponse.limit) &&
        Objects.equals(this.itemDetails, partnerFeedResponse.itemDetails)&&
        Objects.equals(this.additionalProperties, partnerFeedResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PartnerFeedResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PartnerFeedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PartnerFeedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartnerFeedResponse is not found in the empty JSON string", PartnerFeedResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartnerFeedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartnerFeedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartnerFeedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartnerFeedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PartnerFeedResponse>() {
           @Override
           public void write(JsonWriter out, PartnerFeedResponse value) throws IOException {
           ...
           @Override
           public PartnerFeedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PartnerFeedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PartnerFeedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartnerFeedResponse
  * @throws IOException if the JSON string is invalid with respect to PartnerFeedResponse
  */
  public static PartnerFeedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartnerFeedResponse.class);
  }

 /**
  * Convert an instance of PartnerFeedResponse to an JSON string
  *
  * @return JSON string
  */
